...
10. Extend reservation: Duration endpoint. Add GET /reservations/{id}/duration — return length in minutes; add unit test. (pending)
11. Search by Date Range: GET /reservations/search?from=...&to=... — return overlapping reservations; add tests (pending)
12. Count Active Reservations per User: GET /reservations/active/count?userId=... — return integer; add tests (pending)
